...
<!-- Brief description: adding a tool, fixing a link, improving a doc, etc. -->
...
- [ ] Has working documentation a new user can follow
- [ ] Entry follows the table format: `| [Emoji Name](url) | One-sentence description | OrCAD note or — | License |`
...
<!-- Does this tool connect to OrCAD? If yes, briefly describe how. If not applicable, write N/A. -->
