...
[![Works with OrCAD](https://img.shields.io/badge/Works%20with-OrCAD-red?style=flat-square)](docs/orcad-integration/)
[![Works with KiCad](https://img.shields.io/badge/Works%20with-KiCad-blue?style=flat-square)](https://www.kicad.org/)

<br>

<a href="#-quick-start">🚀 Quick Start</a> &nbsp;·&nbsp;
<a href="#️-workflow-map">🗺️ Workflow Map</a> &nbsp;·&nbsp;
<a href="#-tools-by-stage">📂 Tools by Stage</a> &nbsp;·&nbsp;
<a href="#-orcad-integration-cheatsheet">🔌 OrCAD Cheatsheet</a> &nbsp;·&nbsp;
...
> ⭐ **If this saves you a day of searching, [star the repo](https://github.com/piyushbag/awesome-pcb-workflow/stargazers) — that's how the next engineer finds it.**
...
|---|---|---|
| [⚡ atopile](https://github.com/atopile/atopile) | Write PCB designs in code — generates schematics from typed, reusable Python modules | Schematic |
| [🤖 KiBot](https://github.com/INTI-CMNB/KiBot) | CI/CD automation — Gerbers, BOM, drill, PDF docs on every git commit | Fabrication |
| [📊 Interactive BOM](https://github.com/openscopeproject/InteractiveHtmlBom) | One-click HTML BOM with clickable component highlighting on the PCB image | BOM |
| [🔬 openEMS](https://openems.de) | Full 3D EM field simulation — replaces expensive SI tools like HFSS | Simulation |
| [🧪 PyMeasure](https://github.com/pymeasure/pymeasure) | Python instrument control: Keysight, Tektronix, R&S, Rohde & Schwarz | Testing |
...
<details>
<summary>12 workflow stages · Click to expand</summary>
...
- [🖥️ PCB Layout & EDA](#️-pcb-layout--eda)
...
| [🗂️ Obsidian](https://obsidian.md) | Free-form engineering notebook: decisions, constraints, block diagrams, links | Free (Proprietary core, free for personal use) |
...
>
> Export OrCAD Capture schematic to `.cdl` or `.net` (Cadence netlist) and import into KiCad using the built-in netlist import. Most forward-annotation workflows survive intact.
...
| [🗄️ KiCad Library Convention (KLC)](https://klc.kicad.org) | Standards guide for building clean, standardized libraries | — |
...
| [🔧 LTspice](https://www.analog.com/en/design-center/design-tools-and-calculators/ltspice-simulator.html) | Free (not open-source) but industry-standard; `.asc` files compatible with ngspice | Analog design verification | Freeware |
...
*Catch SI/EMC problems before fab — boards are expensive, simulation is free.*
...
| Tool | Description | OrCAD Integration | License |
|---|---|---|---|
| [🟦 KiCad pcbnew](https://www.kicad.org) | World-class open PCB layout with interactive router, DRC, and 3D view | Import via IPC-2581 or KiCad netlist | GPL-3.0 |
| [🌐 Horizon EDA](https://github.com/horizon-eda/horizon) | Real-time DRC, constraint-driven routing, pooled library | — | GPL-3.0 |
...
| [📐 LibrePCB](https://librepcb.org) | Beginner-friendly with strict design rule enforcement, clean UI | — | GPL-3.0 |
...
| Tool | Description | License |
|---|---|---|
| [🧊 KiCad 3D Viewer](https://www.kicad.org) | Real-time 3D PCB viewer with STEP, VRML, and IDF export | GPL-3.0 |
...
| [🔍 BoardView / OpenBoardView](https://github.com/openboardview/OpenBoardView) | View `.brd` / `.bvr` board files for repair and reverse engineering | MIT |
...
| [🔧 pysmu](https://github.com/analogdevicesinc/libsmu) | Python control for Analog Devices SMU instruments | BSD |
...
| Tool | Description | License |
|---|---|---|
| [🌐 Kitspace](https://kitspace.org) | GitHub for hardware — public PCB project hosting with 3D preview and BOM pricing | AGPL-3.0 |
| [📦 Aisler](https://aisler.net) | Shareable PCB project pages with fabrication integration | Free |
| [🤝 Diode.io](https://www.withdiode.com) | Browser-based 3D PCB viewer for stakeholder reviews | Free |
...
| [📝 Hardware Version Control](docs/git-for-hardware.md) | Git workflow for PCB: what to commit, binary handling, CI integration | — |
...
| [📘 The Circuit Designer's Companion](https://www.elsevier.com/books/the-circuit-designers-companion/williams/978-0-08-097138-8) | Peter Williams — essential reference for analog circuit board design |
...
| [🎓 Altium Academy](https://www.altium.com/documentation/resources) | Free reference material even if you don't use Altium |
...
OrCAD 3D       ──(STEP export)──────────▶  FreeCAD / OpenSCAD / KiCad 3D Viewer
```
...
Contributions are what make this the most useful PCB resource on the internet. Every PR is welcome.

**To add a tool:**

1. [Fork this repo](https://github.com/piyushbag/awesome-pcb-workflow/fork)
2. Add the tool to the correct workflow stage table
3. Follow the table format: `| [Name](url) | One-sentence description | OrCAD note or — | License |`
4. Submit a PR with title: `Add [Tool Name] to [Stage]`

**Criteria for inclusion:**

- ✅ Open-source (Apache, MIT, GPL, or equivalent) or free-to-use with clear terms
- ✅ Actively maintained (commit in the last 18 months) or historically significant
- ✅ Relevant to professional hardware design engineers, not just hobbyist use
- ✅ One clear entry per tool — no duplicates
- ❌ No paywalled tools or SaaS without a meaningful free tier
- ❌ No self-promotion without demonstrated community adoption
...
> 🌟 **[Star the repo](https://github.com/piyushbag/awesome-pcb-workflow/stargazers)** to get notified when new tools are added, and to help other engineers find this resource.
...
This list is released into the public domain under [CC0 1.0](LICENSE). No attribution required — fork it, embed it, ship it.
